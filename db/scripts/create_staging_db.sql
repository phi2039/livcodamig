...
CREATE TABLE STAGING.STAGED_PARTIAL_BALANCES
(
  CMPCODE VARCHAR(12)
, YR INTEGER
, PERIOD INTEGER
...
;CREATE INDEX idx_STAGED_PARTIAL_BALANCES ON STAGING.STAGED_PARTIAL_BALANCES(CMPCODE,EL1,EL2,EL3,EL4,EL5,EL6,DOC_CURCODE)
;CREATE INDEX idx_STAGED_PARTIAL_BALANCES2 ON STAGING.STAGED_PARTIAL_BALANCES(CMPCODE,ACCODE,DOC_CURCODE)
;

CREATE TABLE STAGING.AUTO_PARTIAL_BALANCES
(
  CMPCODE VARCHAR(12)
, YR INTEGER
, PERIOD INTEGER
...
;CREATE INDEX idx_AUTO_PARTIAL_BALANCES ON STAGING.AUTO_PARTIAL_BALANCES(CMPCODE,EL1,EL2,EL3,EL4,EL5,EL6,DOC_CURCODE)
;CREATE INDEX idx_AUTO_PARTIAL_BALANCES2 ON STAGING.AUTO_PARTIAL_BALANCES(CMPCODE,ACCODE,DOC_CURCODE)
;


CREATE TABLE STAGING.AUTO_PARTIAL_BAL_SOURCE
(
  CMPCODE VARCHAR(12)
, EL1 VARCHAR(72)
, EL2 VARCHAR(72)
...
;CREATE INDEX idx_AUTO_PARTIAL_BAL_SOURCE ON STAGING.AUTO_PARTIAL_BAL_SOURCE(CMPCODE,EL1,EL2,EL3,EL4,EL5,EL6,DOC_CURCODE)
;

CREATE TABLE STAGING.AUTO_PARTIAL_BALANCE_ERR
(
  CMPCODE VARCHAR(12)
, EL1 VARCHAR(72)
, EL2 VARCHAR(72)
...
CREATE TABLE STAGING.PARTIAL_BALANCE_ERR
(
  CMPCODE VARCHAR(12)
, EL1 VARCHAR(72)
, EL2 VARCHAR(72)
...
-- Migration Rules --
CREATE TABLE STAGING.ACCT_BALANCE_SOURCE
(
	CMPCODE VARCHAR(12)
, EL1 VARCHAR(72)
, RULE VARCHAR(72)
...
;
;CREATE INDEX idx_ACCT_BALANCE_SOURCE_lookup ON STAGING.MAPPED_BALANCES(CMPCODE, EL1)
;

CREATE TABLE STAGING.ACCT_BALANCE_SOURCE_ERR
(
	CMPCODE VARCHAR(12)
, EL1 VARCHAR(72)
, RULE VARCHAR(72)
