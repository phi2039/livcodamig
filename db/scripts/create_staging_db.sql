...
;CREATE INDEX idx_CAD_BALANCES2 ON OPEN_MIG.CAD_BALANCES(CMPCODE,ACCODE)
;

CREATE TABLE OPEN_MIG.GL_LOCAL_BALANCES
(
  CMPCODE VARCHAR(12)
, EL1 VARCHAR(72)
, EL2 VARCHAR(72)
...
;CREATE INDEX idx_GL_LOCAL_BALANCES ON OPEN_MIG.GL_LOCAL_BALANCES(CMPCODE,EL1,EL2,EL3,EL4,EL5,EL6)
;CREATE INDEX idx_GL_LOCAL_BALANCES2 ON OPEN_MIG.GL_LOCAL_BALANCES(CMPCODE,ACCODE)
;
