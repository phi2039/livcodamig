...
create table hfm.gl_data_period (yr integer, period integer, cmpcode varchar(12), el1 varchar(12), el3 varchar(12), local_amt decimal, func_amt decimal) as
select 2015, 0, cmpcode, el1, el3, sum(local_amt) as local_amt, sum(func_amt) as func_amt from open_mig.staged_balances 
where group by 2015, 0, cmpcode, el1, el3;
...
create table hfm.gl_data_ytd (yr integer, period integer, cmpcode varchar(12), el1 varchar(12), el3 varchar(12), local_amt decimal, func_amt decimal) as
select p.yr, p.period, net.cmpcode, net.el1, net.el3, sum(net.local_amt) as local_amt, sum(func_amt) as func_amt
...
select
	y.yr,
	y.period,
	y.cmpcode || '_' || c.curlocal as entity,
	y.el1 as account,
	...
	'[None]' as project,
	y.local_amt as amount
from hfm.gl_data_ytd y
left join staging_templates.cmp_master c on c.cmpcode=y.cmpcode
where 
y.cmpcode in (
'VMX',
'VEK',
